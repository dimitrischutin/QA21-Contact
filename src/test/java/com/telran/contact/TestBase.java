...
public class TestBase {
    ...
    public boolean isElementPresend(By locator) {
    ...
    public boolean isLoginTabPresent() {
        return !isElementPresend(By.xpath("//a[contains(.,'LOGIN')]"));
    }

    public boolean isSignOutTabPresent() {
        return isElementPresend(By.xpath("//button[contains(.,'Sign Out')]"));
    }

    public boolean isLoginRegistrationFormPresent() {
        return isElementPresend(By.cssSelector(".login_login__3EHKB"));
    }
